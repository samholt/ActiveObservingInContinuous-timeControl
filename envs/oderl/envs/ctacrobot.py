    ...
    **REFERENCE:**
    ...
    def torch_rhs(self, state, action):
        ...
        if sixD:
            return torch.stack(
                [
                    -sintheta1 * dtheta1 / C1,
                    costheta1 * dtheta1 / C1,
                    -sintheta2 * dtheta2 / C2,
                    costheta2 * dtheta2 / C2,
                    ddtheta1,
                    ddtheta2,
                ],
                -1,
    ...
    def diff_obs_reward_(self, state, exp_reward=False):
        ...
        p2 = [p1[0] - self.LINK_LENGTH_2 * torch.cos(th1 + th2), p1[1] + self.LINK_LENGTH_2 * torch.sin(th1 + th2)]
